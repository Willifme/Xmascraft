...
//            GenLayer, GenLayerIsland, GenLayerFuzzyZoom, GenLayerDimensionOcean1, 
//            GenLayerZoom, GenLayerDimensionOcean2, GenLayerDimensionRiver, GenLayerSmooth, 
//            GenLayerDimensionMajorBiome, GenLayerDimensionMinorBiome, GenLayerDimensionMiscBiome, WorldProviderBase, 
//            GenLayerDimensionBorderBiome, GenLayerDimensionWater, GenLayerVoronoiZoom
...
public abstract class GenLayerDimension extends GenLayer
{
    ...
    public static GenLayer[] getGenLayers(long l, WorldProviderBase worldproviderbase)
    {
        ...
        genlayervoronoizoom.func_35496_b(l);
        return (new GenLayer[] {
