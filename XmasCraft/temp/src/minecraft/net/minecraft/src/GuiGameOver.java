...
//            WorldProviderBase, DimensionAPI, EntityPlayerSP
...
public class GuiGameOver extends GuiScreen
{
    ...
    protected void func_572_a(GuiButton p_572_1_)
    {
        ...
        case 1: // '\001'
            ...
            if((field_945_b.field_6324_e.field_4209_q instanceof WorldProviderBase) && !field_945_b.field_6324_e.field_1026_y)
            {
                DimensionAPI.respawnPlayer(field_945_b);
            } else
            {
