...
//            Block, Item, NBTTagCompound, DimensionAPI, 
//            StatList, EntityPlayer, IItemUse, IItemRightClick, 
//            EnchantmentHelper, EntityLiving, World, NBTTagList, 
//            Enchantment, Entity, EnumAction, EnumRarity
...
public final class ItemStack
{
    ...
    public static ItemStack func_35864_a(NBTTagCompound p_35864_0_)
    {
        ...
        return itemstack.func_1091_a() != null ? itemstack : null;
    }
    ...
    public boolean func_1090_a(EntityPlayer p_1090_1_, World p_1090_2_, int p_1090_3_, int p_1090_4_, int p_1090_5_, int p_1090_6_)
    {
        ...
        if(DimensionAPI.itemUseMap.containsKey(Integer.valueOf(field_1617_c)))
        {
            p_1090_1_.func_25058_a(StatList.field_25172_A[field_1617_c], 1);
            IItemUse iitemuse = (IItemUse)DimensionAPI.itemUseMap.get(Integer.valueOf(field_1617_c));
            iitemuse.onItemUse(this, p_1090_1_, p_1090_2_, p_1090_3_, p_1090_4_, p_1090_5_, p_1090_6_);
            return true;
        }
        if(flag)
        {
    ...
    {
        if(DimensionAPI.itemRightClickMap.containsKey(Integer.valueOf(field_1617_c)))
        {
            IItemRightClick iitemrightclick = (IItemRightClick)DimensionAPI.itemRightClickMap.get(Integer.valueOf(field_1617_c));
            return iitemrightclick.onItemRightClick(this, p_1093_1_, p_1093_2_);
        } else
        {
