...
//            TextureFX, MathHelper, RenderEngine
...
public class TextureCustomPortalFX extends TextureFX
{
            ...
            for(int k = 0; k < 16; k++)
            {
                for(int l = 0; l < 16; l++)
                {
                    ...
                    for(int i1 = 0; i1 < 2; i1++)
                    {
                        ...
                        float f10 = (float)Math.atan2(f8, f7) + ((((float)j / 32F) * 3.141593F * 2.0F - f9 * 10F) + (float)(i1 * 2)) * (float)(i1 * 2 - 1);
                        f10 = (MathHelper.func_1106_a(f10) + 1.0F) / 2.0F;
                        f10 /= f9 + 1.0F;
                        f4 += f10 * 0.5F;
                    }
    ...
    {
        GL11.glBindTexture(3553, renderengine.func_1070_a(textureOverride));
    }
}
