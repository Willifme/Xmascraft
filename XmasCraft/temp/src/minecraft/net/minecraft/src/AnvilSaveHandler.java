...
//            WorldProviderBase, WorldInfo, WorldProvider, IChunkLoader
...
public class AnvilSaveHandler extends SaveHandler
{
    ...
    public IChunkLoader func_22149_a(WorldProvider p_22149_1_)
    {
        ...
        if(p_22149_1_ instanceof WorldProviderBase)
        {
            File file3 = new File(file, ((WorldProviderBase)p_22149_1_).getSaveFolderName());
            file3.mkdirs();
