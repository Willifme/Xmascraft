...
public class WorldGenXmascraftHugeTrees extends WorldGenerator
{
    ...
    public WorldGenXmascraftHugeTrees(boolean par1, int par2, int par3, int par4)
    {
        super(par1);
        field_48195_a = par2;
        woodMetadata = par3;
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        if (k != Block.grass.blockID && k != Block.blockSnow.blockID || par4 >= 256 - i - 1)
        {
            return false;
        }

        par1World.setBlock(par3, par4 - 1, par5, Block.blockSnow.blockID);
        par1World.setBlock(par3 + 1, par4 - 1, par5, Block.blockSnow.blockID);
        par1World.setBlock(par3, par4 - 1, par5 + 1, Block.blockSnow.blockID);
        par1World.setBlock(par3 + 1, par4 - 1, par5 + 1, Block.blockSnow.blockID);
