...
public class WorldGenNorthpoleForest extends WorldGenerator
{
    public WorldGenNorthpoleForest(boolean par1)
    {
        super(par1);
    }
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        if (k != Block.grass.blockID && k != mod_Xmascraft.XmascraftSnow.blockID || par4 >= 256 - i - 1)
        {
            return false;
        }
