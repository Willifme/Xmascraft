...
public abstract class BiomeGenBase
{
    ...
    public static final BiomeGenBase northpolehill = (new BiomeGenNorthPoleHills(65)).setColor(0x606060).setBiomeName("Northpole Hills").setMinMaxHeight(0.2F, 1.3F).setTemperatureRainfall(0.0F, 0.5F);
    public static final BiomeGenBase northpolepanes = (new BiomeGenNorthPolePlanes(66)).setColor(0x606060).setBiomeName("Northpole Planes").setMinMaxHeight(0.2F, 1.3F).setTemperatureRainfall(0.0F, 0.5F);
    ...
    protected WorldGenNorthpoleForest worldGenNorthpoleForest;
    protected WorldGenNorthpoleBigTree worldGenNorthpoleBigTree;
    protected WorldGenNorthpoleTrees worldGenNorthpoleTrees;
    ...
    protected BiomeGenBase(int par1)
    {
        ...
        worldGenNorthpoleBigTree = new WorldGenNorthpoleBigTree(false);
        worldGenForest = new WorldGenForest(false);
        worldGenNorthpoleTrees = new WorldGenNorthpoleTrees(false);
        worldGenNorthpoleForest = new WorldGenNorthpoleForest(false);
