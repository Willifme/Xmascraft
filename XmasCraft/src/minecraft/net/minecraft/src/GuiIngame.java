    ...
    public void renderGameOverlay(float par1, boolean par2, int par3, int par4)
    {
        ...
        if (mc.gameSettings.showDebugInfo)
        {
            ...
            if (mc.theWorld != null && mc.theWorld.blockExists(i7, i8, l8))
            {
                ...
                drawString(fontrenderer, (new StringBuilder()).append("lc: ").append(chunk.getTopFilledSegment() + 15).append(" b: ").append(chunk.func_48490_a(i7 & 0xf, l8 & 0xf, mc.theWorld.getWorldChunkManager()).biomeName).append(" bl: ").append(chunk.getSavedLightValue(EnumSkyBlock.Block, i7 & 0xf, i8, l8 & 0xf)).append(" sl: ").append(chunk.getSavedLightValue(EnumSkyBlock.Sky, i7 & 0xf, i8, l8 & 0xf)).append(" rl: ").append(chunk.getBlockLightValue(i7 & 0xf, i8, l8 & 0xf, 0)).toString(), 2, 96, 0xe0e0e0);
            }
