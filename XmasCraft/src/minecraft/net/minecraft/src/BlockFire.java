...
public class BlockFire extends Block
{
	...
	public void onBlockAdded(World par1World, int par2, int par3, int par4)
	{
		...
		if (par1World.getBlockId(par2, par3 - 1, par4) == mod_Xmascraft.XmascraftStone.blockID && mod_Xmascraft.XmascraftPortal.tryToCreatePortal(par1World, par2, par3, par4))
		{
			return;
		}
